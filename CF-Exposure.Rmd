...
![**Figure 3.** Metrics of extreme temperature at (NAME). Top plot represents the number of days per year when maximum temperature exceeds 95 ° F at (NAME) historically and in both climate futures. The bottom plot is the number of days per year when heat index reaches ‘dangerous’ levels (103-124 °F).](Data/)
