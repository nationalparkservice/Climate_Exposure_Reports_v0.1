...
params:
  region:
    ...
    value: NCPN
    input: select
    choices: [APHN, CHDN, CUPN, ERMN, GLKN, GRYN, GULN, HTLN, KLMN, CRLA, MEDN, MIDN, MOJN, NCBN, NCCN, NCPN, NCRN, NETN, NGPN, ROMN, SCPN, SECN, SFAN, SFCN, SIEN, SODN, SOPN, UCBN]
  name: 
    label: "Park Name"
    value: TUSK
    input: select
    choices: [ABLI, ACAD, ADAM, AFBG, AGFO, ALFL, ALPO, AMIS, ANDE, ANJO, ANTI, APCO, APIS, APPA, ARCH, ARHO, ARPO, ASIS, AZRU, BADL, BAND, BEOL, BEPA, BIBE, BICA, BICR, BICY, BIHO, BISC, BISO, BITH, BLCA, BLRI, BLRV, BLUE, BOAF, BOHA, BOST, BOWA, BRCA, BRCR, BRVB, BUFF, CACH, CACL, CACO, CAGR, CAHA, CAJO, CALO, CAMO, CANA, CANE, CANY, CARE, CARI, CARL, CASA, CATO, CAVE, CAVO, CAWO, CEBE, CEBR, CECH, CHAM, CHAT, CHCH, CHCU, CHIC, CHIR, CHIS, CHOH, CHPI, CHSC, CHYO, CIRO, CLBA, COGA, COLM, COLO, CONG, CORO, COWP, CRLA, CRMO, CRMP, CUGA, CUIS, CURE, CUVA, DAAV, DDEM, DELA, DEPO,DETO,DEVA, DEWA, DINO, EBLA, EDAL, EDIS, EFMO, EISE, ELMA, ELMO, ELRO, EUON, EVER, FEHA, FIIS, FILA, FLFO, FLNI, FOBO, FOBU, FOCA, FODA, FODO, FOFR, FOLA, FOLS, FOMA, FOMC, FOMR, FONE, FOPU, FOSC, FOSM, FOST, FOTH, FOUN, FOUS, FOVA, FOWA, FRDE, FRDO, FRHI, FRLA, FRRI, FRSP, FRST, GARI, GATE, GEGR, GERO, GETT, GEWA, GICL, GLAC, GLCA, GOGA, GOSP, GRBA, GRCA, GREE, GRKO, GRPO, GRSA, GRSA, GRSM, GRTE, GUCO, GUIS, GUMO, GWCA, GWMP, HAFE, HAFO, HAGR, HAMP, HART, HATU, HEHO, HOBE, HOCU, HOFR, HOFU, HOME, HOSP, HOVE, HSTR, HUTR, IATR, INDE, INDU, ISRO, JAGA, JAZZ, JECA, JEFF, JEFM, JELA, JICA, JODA, JODR, JOFI, JOFL, JOMU, JOTR, KAWW, KEMO, KEWE, KICA, KIMO, KLGO, KNRI, KOWA, LABE, LACH, LAKE, LAMR, LARO, LAVO, LECL, LEWI, LIBI, LIBO, LIHO, LINC, LIRI, LONG, LOSA, LOWE, LYBA, LYJO, MABE, MABI, MACA, MALL, MALU, MANA, MANZ, MAPR, MAVA, MAWA, MEMY, MEVE, MIIN, MIMA, MIMI, MISP, MISS, MLKM, MNRR, MOCA, MOCR, MOJA, MONO, MORA, MORR, MORU, MUWO, NABR, NACA, NATC, NATR, NAVA, NEBE, NEPE, NERI, NICO, NIOB, NISI, NOCA, NOCO, OBRI, OCMU, OLYM, ORCA, ORPI, OZAR, PAAL, PAAV, PAGR, PAIS, PECO, PEFO, PERI, PETE, PETR, PIMA, PINN, PIPE, PIRO, PISC, PISP, POPO, PORE, PRWI, PULL, RABR, REDW, REER, RICH, RIGR, RIRA, ROCR, ROLA, ROMO, RORI, ROWI, RRBH, RUCA, SAAN, SACN, SAGA, SAGU, SAHI, SAIR, SAJH, SAMA, SAMO, SAND, SAPA, SAPU, SARA, SCBL, SEMO, SEQU, SHEN, SHIL, SLBE, SPAR, STEA, STGE, STLI, STON, STRI, SUCR, TAPR, THIS, THKO, THRB, THRI, THRO, THST, TICA, TIMU, TONT, TUAI, TUIN, TULE, TUMA, TUPE, TUSK, TUZI, ULSG, UPDE, VAFO, VALL, VAMA, VICK, VIVE, VOYA, WABA, WACA, WACO, WAMO, WEFA, WHHO, WHIS, WHMI, WHSA, WICA, WICL, WICR, WIHO, WORI, WOTR, WRBR, WUPA, WWII, WWIM, YELL, YOSE, YUHO, ZION]
toc: 
theme: united
---
...
library(stars);library(dplyr);library(ggplot2);library(ggthemes);library(viridis);library(here);library(ggrepel);library(rlang);library(units);library(knitr);library(purrr);library(glue); library(gt); library(officer);library(dplyr)
...
![**Figure 3.** Metrics of extreme temperature at `r params$name`. Top plot represents the number of days per year when maximum temperature exceeds 95 ° F at `r params$name` historically and in both climate futures. The bottom plot is the number of days per year when heat index reaches 'dangerous' levels (103-124 °F).](Data/TUSK/WarmWet_HotDry/figures/OverHotTemp-HI.Dan-Panel.png)
