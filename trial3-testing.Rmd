...
library(stars);library(dplyr);library(ggplot2);library(ggthemes);library(viridis);library(here);library(ggrepel);library(rlang);library(units);library(knitr);library(purrr);library(glue); library(gt); library(officer);library(dplyr); library(abind); library(sf);library(officedown)

```

```{r Iterate, echo=FALSE, message=FALSE, warning=FALSE}
#varNames<-c("ACAD", "MACA", "TUSK")

# for (i in 1:length(varNames)) {
#     body_replace_all_text(old_value = "TUSK",
